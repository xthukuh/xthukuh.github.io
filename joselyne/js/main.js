(function ($) {
	...
	function setPrettyPhoto() {
		...
		$(".grid-item:visible a[rel^='prettyPhoto']").prettyPhoto({
			...
			// allow_resize: true,
			social_tools: false,
			// social_tools: '<div class="open-image" style="padding:10px;position:absolute;top:-7px;left:50%;"><a href="{path}" target="_blank" style="padding:4px 4px;font-size:12px;color:#444;background:#fff;border-radius:5px">OPEN</a></div>',
